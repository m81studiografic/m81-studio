...
export const article = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "audioRo",
      title: "Audio articol (MP3 — voce premium, opțional)",
      description:
        "Dacă lipsește, site-ul folosește vocea browserului. Îl generăm cu scriptul de audio.",
      type: "file",
      group: "ro",
    ...
    defineField({
      name: "audioEn",
      title: "Article audio (MP3 — premium voice, optional)",
      description:
        "If missing, the site falls back to the browser voice. Generated by the audio script.",
      type: "file",
      group: "en",
      options: { accept: "audio/mpeg" },
    }),

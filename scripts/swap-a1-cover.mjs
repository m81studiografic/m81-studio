// Schimbă coperta articolului 1 cu o imagine care exprimă „afacere → brand".
...
const CANDIDATES = [
  "https://images.unsplash.com/photo-1635405074683-96d6921a2a68?auto=format&fit=crop&w=2400&q=80",
];
...
async function uploadLandscape() {
  for (const url of CANDIDATES) {
    ...
    const up = await fetch(`${BASE}/assets/images/${DATASET}?filename=a1-cover-brand.jpg`, {
      method: "POST",
...
async function main() {
  ...
  const coverImage = {
    ...
    alt: "Construirea unei afaceri online — momentul în care o afacere începe să devină un brand",
  };

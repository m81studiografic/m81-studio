...
/* ── Page ── */
export default function IncepeProiectPage() {
                    ...
                    {step===3 && (
                      <div style={{ display:"flex", flexDirection:"column", gap:18 }}>
                        ...
                        <Field label="Buget estimativ *">
                          <StyledSelect value={form.budget} onChange={v=>setForm(f=>({...f,budget:v}))} placeholder="Selectează bugetul..." options={["2.000 – 5.000 €","5.000 – 10.000 €","10.000 – 20.000 €","20.000 €+"]}/>
                        </Field>
                        ...
                        <div style={{ display:"flex", gap:10, paddingTop:8 }}>
                          ...
                          <div style={{ flex:1 }}>
                            <PrimaryBtn onClick={() => { if (canSubmit) setSubmitted(true); }} disabled={!canSubmit}>
                              Trimite proiectul →
                            </PrimaryBtn>
                          </div>
                        </div>
